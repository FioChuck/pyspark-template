...
spark = (
            ...
            .config(
                "spark.jars.packages",
                "com.google.cloud.spark:spark-3.5-bigquery:0.42.2,org.apache.iceberg:iceberg-spark-runtime-3.5_2.12:1.6.1"
                )
            .config("spark.jars", "gcs-connector-hadoop3-2.2.28-shaded.jar,iceberg-bigquery-catalog-1.6.1-1.0.1-beta.jar")
            ...
            .config("spark.sql.catalog.bl_catalog.catalog-impl", "org.apache.iceberg.gcp.bigquery.BigQueryMetastoreCatalog")
...
df = spark.sql("SELECT * FROM iceberg.wiki")
df.show(5);
